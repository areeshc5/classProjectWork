...
//		drawSlot(pic, 4, 6);
	 ...
	 *  Avoid an AIOOBE, but any portion of the box that fits on 
	 *  the canvas should be drawn
	 * @param pic
	 * @param i
	 * @param j
	 */
	...
	private static void drawAt(String string, String[][] pic, int row, int col) {
		...
		//because the row must exist before the column can exist in it
	 ...
	 * there is a vertical line to the left of (i,j) and one 
	 * to the right
